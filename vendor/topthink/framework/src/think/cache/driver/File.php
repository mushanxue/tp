...
class File extends Driver
{
    ...
    public function clear(): bool
    {
        ...
        $dirname = substr($dirname,0,-13);
        $this->rmdir($dirname.'/admin/cache/');
        $this->rmdir($dirname.'/api/cache/');
        $this->rmdir($dirname.'/home/cache/');
        $this->rmdir($dirname.'/mobile/cache/');
        $this->rmdir($dirname.'/seller/cache/');
        $this->rmdir($dirname.'/sellerApi/cache/');
        $this->rmdir($dirname.'/shop/cache/');
        $this->rmdir($dirname.'/supplier/cache/');
