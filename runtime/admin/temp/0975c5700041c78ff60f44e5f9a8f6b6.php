<?php /*a:2:{s:58:"Z:\TPshop20200701_tp6\app\admin\view\goods/stock_list.html";i:1593659384;s:55:"Z:\TPshop20200701_tp6\app\admin\view\public/layout.html";i:1593659384;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                <li><a <?php if($_REQUEST['mtype']  != -1): ?>class= 'current'<?php endif; ?>  href="<?php echo url('admin/goods/StockList?mtype=1'); ?>"><span>入库日志</span></a></li>
                <li><a <?php if($_REQUEST['mtype'] == -1): ?>class= 'current'<?php endif; ?> href="<?php echo url('admin/goods/StockList?mtype=-1'); ?>"><span>出库日志</span></a></li>
                <li><a class="" href="<?php echo url('admin/goods/lowStockWarn'); ?>"><span>库存预警</span></a></li>
                <li><a class="" href="<?php echo url('admin/goods/alterStock'); ?>"><span>库存盘点</span></a></li>
            </ul>
        </div>
    </div>
    <!-- 操作说明 -->
    ...
    <div class="flexigrid">
        <div class="mDiv">
            ...
            <form class="navbar-form form-inline" id="search-form" method="get" action="<?php echo url('Goods/stockList'); ?>" onsubmit="return check_form();">
                <input type="hidden" name="ctime" id="ctime" value="<?php echo $ctime; ?>">
                <div class="sDiv">
                    <div class="sDiv2" style="margin-right: 10px;">
                        <input type="text" size="30" id="start_time" value="<?php echo $start_time; ?>" placeholder="起始时间" class="qsbox" autocomplete="off">
                        <input type="button" class="btn" value="起始时间">
                    </div>
                    <div class="sDiv2" style="margin-right: 10px;">
                        <input type="text" size="30" id="end_time" value="<?php echo $end_time; ?>" placeholder="截止时间" class="qsbox" autocomplete="off">
                        <input type="button" class="btn" value="截止时间">
                    </div>
                    <div class="sDiv2" style="margin-right: 10px;border: solid 1px #D7D7D7;">
                        <select class="form-control" id="status" name="mtype" style="border: none;height: 28px;margin-top: -5px">
                    ...
                    <div class="sDiv2">
                        <input size="30" placeholder="商品名称" value="<?php echo app('request')->param('goods_name'); ?>" name="goods_name" class="qsbox" type="text">
                        ...
                        <tr>
                            ...
                            <td align="center" class="">
                                <div style="text-align: center; width: 100px;">
									<?php switch($v['group']): case "0": ?>管-<?php break; case "1": ?>供-<?php break; case "2": ?>会-<?php break; default: ?>
									<?php endswitch; ?>
									<?php echo $v['muid']; ?>
								</div>
                            </td>
                            ...
                            <td align="center" class="">
                                <div style="text-align: center; width: 130px;"><?php echo date("Y-m-d H:i:s",!is_numeric($v['ctime'])? strtotime($v['ctime']) : $v['ctime']); ?></div>
                            </td>
