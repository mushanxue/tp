<?php /*a:1:{s:42:"Z:\demo\app\admin\view\user/ajaxindex.html";i:1593659384;}*/ ?>
    ...
    <table>
        ...
        <?php if(is_array($userList) || $userList instanceof \think\Collection || $userList instanceof \think\Paginator): $i = 0; $__LIST__ = $userList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
            <tr data-id="<?php echo $list['user_id']; ?>">
                ...
                <td align="left" class="">
                    <div style="text-align: center; width: 120px;"><?php echo date('Y-m-d H:i',!is_numeric($list['reg_time'])? strtotime($list['reg_time']) : $list['reg_time']); ?></div>
                </td>
                <td align="center" class="handle">
                    <div style="text-align: center; width: 170px; max-width:250px;">
                        <a class="btn blue" href="<?php echo url('Admin/user/detail',array('id'=>$list['user_id'])); ?>">详情</a>
                        <a class="btn blue" href="<?php echo url('Admin/user/account_log',array('id'=>$list['user_id'])); ?>">资金</a>
                        <a class="btn blue" href="<?php echo url('Admin/user/address',array('id'=>$list['user_id'])); ?>">收货地址</a>
                    </div>
                </td>
