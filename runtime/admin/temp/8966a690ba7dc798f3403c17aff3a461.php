<?php /*a:2:{s:48:"Z:\demo\app\admin\view\promotion/index_list.html";i:1593659384;s:41:"Z:\demo\app\admin\view\public/layout.html";i:1593659384;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="marketing_menu page">
	<div class="menu">
		<div class="content">
			...
			<ul>
				<a href="<?php echo url('Promotion/flash_sale'); ?>">
					<li>
				...
				<a href="<?php echo url('Promotion/group_buy_list'); ?>">
					<li>
				...
				<a href="<?php echo url('Promotion/prom_goods_list'); ?>">
					<li>
				...
				<a href="<?php echo url('Promotion/prom_order_list'); ?>">
					<li>
				...
				<a href="<?php echo url('PreSell/index'); ?>">
					<li>
				...
				<a href="<?php echo url('Combination/index'); ?>">
					<li>
	...
	<div class="menu">
		<div class="content">
			...
			<ul>
				<a href="<?php echo url('Team/index'); ?>">
					<li>
	...
	<div class="menu">
		<div class="content">
			...
			<ul>
				...
				<a href="<?php echo url('Coupon/send_list'); ?>">
					<li>
