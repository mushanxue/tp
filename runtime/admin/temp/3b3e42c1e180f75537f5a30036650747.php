<?php /*a:2:{s:38:"Z:\demo\app\admin\view\user/index.html";i:1593659384;s:41:"Z:\demo\app\admin\view\public/layout.html";i:1593659384;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    ...
    <div class="flexigrid">
        <div class="mDiv">
            ...
            <div class="fbutton"><a href="<?php echo url('User/add_user'); ?>"><div class="add" title="添加会员"><span><i class="fa fa-plus"></i>添加会员</span></div></a></div>
                ...
                <div class="sDiv">
                    ...
                    <div class="sDiv2">
                        ...
                        <input type="text" id="search_key" size="30" class="qsbox" placeholder="查询"
                               value="<?php echo app('request')->param('search_key'); ?>">
