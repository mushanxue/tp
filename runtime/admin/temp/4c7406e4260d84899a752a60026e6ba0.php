<?php /*a:2:{s:44:"Z:\demo\app\admin\view\system/shop_info.html";i:1593659384;s:41:"Z:\demo\app\admin\view\public/layout.html";i:1593659384;}*/ ?>
<!doctype html>
<html>
<head>
        ...
        <div class="ncap-form-default">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    ...
                    <span class="err"></span>
                    <p class="notic">默认空图片,最佳显示尺寸为360*360的png图片，正方形图片不宜过大,/public/images/icon_goods_thumb_empty_300.png和/template/mobile/rainbow/static/images/zy.png 有写的权限 </p>
                    <p class="notic">/public/images/icon_goods_thumb_empty_300.png</p>
                    <p class="notic">/template/mobile/rainbow/static/images/zy.png</p>
                </dd>
            </dl>
...
<script type="text/javascript">
    ...
    var changefile = function (o) {
        ...
        fileReader.onload = function () {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo url('Admin/Ueditor/imgUp',['savepath'=>'empty']); ?>",
                async: false,
                dataType: "json",
