<?php /*a:2:{s:39:"Z:\demo\app\admin\view\order/index.html";i:1593659384;s:41:"Z:\demo\app\admin\view\public/layout.html";i:1593659384;}*/ ?>
<!doctype html>
<html>
<head>
  ...
  <div class="flexigrid">
    <div class="mDiv">
	  ...
	  <form class="navbar-form form-inline"  method="post" action="<?php echo url('Admin/order/export_order'); ?>"  name="search-form2" id="search-form2">  
            ...
            <input type="hidden" name="user_id" value="<?php echo app('request')->param('user_id'); ?>">
      ...
      <div class="sDiv">
        ...
        <div class="sDiv2">	   
         ...
         <div class="sDiv2">	                
          ...
          <div class="sDiv2">
              <select  name="from_terminal" class="select" style="border:none;">
                  <option value="">终端</option>
                  <option value="pc">PC端</option>
                  <option value="h5">WAP端</option>
                  <option value="mp">微商城</option>
        ...
        <table cellspacing="0" cellpadding="0">
          <thead>
                ...
                <th align="left" abbr="consignee" axis="col4" class="">
                  ...
                  <th align="left" axis="col1" class="handle">
                    <div style="text-align: left; width: 50px;">终端</div>
                  </th>
                  <th align="left" axis="col1" class="handle">
