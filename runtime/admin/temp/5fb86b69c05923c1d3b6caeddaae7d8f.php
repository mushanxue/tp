<?php /*a:2:{s:53:"Z:\demo\app\admin\view\promotion/prom_goods_list.html";i:1593659384;s:41:"Z:\demo\app\admin\view\public/layout.html";i:1593659384;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
	<div class="fixed-bar">
		...
		<a href="http://help.tp-shop.cn/Index/Help/info/cat_id/5/id/49.html" style="display: <?php echo tpCache('basic.is_manual')?'block':'none'; ?>"  class="manual" target="_blank"><i class="fa fa-calendar"></i>优惠促销手册</a>
	</div>
	<!-- 操作说明 -->
	<div id="explanation" class="explanation">
        <div class="bckopa-tips">
            ...
            <ul>
				...
				<li>促销活动删除：有订单参与的活动不能删除</li>
				<li>根据促销类型添加活动时绑定对应商品进行优惠</li>
				<li>商品促销是针对商品优惠，比如买了这个优惠商品，就可以享受到到优惠。</li>
            </ul>
        </div>
	...
	<div class="flexigrid">
		<div class="mDiv">
            ...
            <a href="<?php echo url('Promotion/prom_goods_info'); ?>"><div class="fbutton"><div title="添加活动" class="add"><span><i class="fa fa-plus"></i>添加活动</span></div></div></a>
            <div class="fbutton"><a href="http://help.tp-shop.cn/Index/Help/info/cat_id/5/id/50.html" target="_blank"><div class="add" title="帮助"><span>帮助</span></div></a></div>
		...
		<!--<div class="tDiv">
			<div class="tDiv2">
				<a href="<?php echo url('Promotion/prom_goods_info'); ?>">
					<div class="fbutton">
						...
						<tr>
							...
							<td align="left" class="">
								<div style="text-align: center; width: 80px;">
									<?php if($vo['is_end'] == 0): ?>
										<span class="yes" onClick="changeTableVal2('prom_goods','id','<?php echo $vo['id']; ?>','is_end',this,'是','否','<?php echo $vo['status_desc']; ?>')" ><i class="fa fa-check-circle"></i>是</span>
										<?php else: ?>
										<span class="no" onClick="changeTableVal2('prom_goods','id','<?php echo $vo['id']; ?>','is_end',this,'是','否')" ><i class="fa fa-ban"></i>否</span>
									<?php endif; ?>
								</div>
							</td>
							...
							<td align="left" class="handle">
								<div style="text-align: left; width: 170px; max-width:170px;">
									<a class="btn blue goods_list" data-url="<?php echo url('Promotion/get_goods',array('id'=>$vo['id'])); ?>">查看商品</a>
									<a class="btn blue" href="<?php echo url('Promotion/prom_goods_info',array('id'=>$vo['id'])); ?>">编辑</a>
									<a class="btn red  del" data-id="<?php echo $vo['id']; ?>">删除</a>
								</div>
							</td>
...
<script>
    ...
    $(document).on('click','.del',function () {
        $.ajax({
            url:"<?php echo url('Promotion/prom_goods_del'); ?>",
