<?php /*a:2:{s:63:"Z:\TPshop20200701_tp6\app\admin\view\system/navigationList.html";i:1593659384;s:55:"Z:\TPshop20200701_tp6\app\admin\view\public/layout.html";i:1593659384;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    ...
    <div class="flexigrid">
        <div class="mDiv">
            ...
            <div class="fbutton"> <a href="<?php echo url('Admin/System/addEditNav'); ?>"><div class="add" title="新增导航"><span><i class="fa fa-plus"></i>新增导航</span></div></a> </div>
        ...
        <div class="bDiv" style="height: auto;">
            <div id="flexigrid" cellpadding="0" cellspacing="0" border="0" data-url="<?php echo url('admin/System/delNavigations'); ?>">
                <table>
                    <tbody>
                        ...
                        <tr data-id="<?php echo $vo['id']; ?>">
                            ...
                            <td align="center" class="handle">
                                <div style="text-align: center; width: 170px; max-width:170px;">
                                    ...
                                    <?php endif; ?>
                                    <a class="btn red" href="<?php echo url('System/delNav',array('id'=>$vo['id'])); ?>">删除</a>
                                    <a href="<?php echo url('Admin/System/addEditNav',array('id'=>$vo['id'])); ?>" class="btn blue">编辑</a> </div>
                            </td>
