<?php /*a:1:{s:81:"C:\Users\admin\Desktop\TPshop20200701_tp6\app\admin\view\goods/ajaxGoodsList.html";i:1593659384;}*/ ?>
<table>
       <tbody>
			 ...
			 <td class="handle" >
                <div style="text-align:left;   min-width:50px !important; max-width:inherit !important;">
                  ...
                  <ul>
                    ...
                    <li><a href="<?php echo url('Admin/Goods/addEditGoods',array('id'=>$list['goods_id'],'type'=>'copy')); ?>">复制商品</a></li>
                    <li><a href="<?php echo url('Admin/Goods/addEditGoods',array('id'=>$list['goods_id'],'type'=>'edit')); ?>">编辑商品</a></li>
