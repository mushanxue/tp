<?php /*a:2:{s:73:"C:\Users\admin\Desktop\TPshop20200701_tp6\app\admin\view\index/index.html";i:1593659407;s:73:"C:\Users\admin\Desktop\TPshop20200701_tp6\app\admin\view\public/left.html";i:1593659384;}*/ ?>
<!doctype html>
<html>
<head>
...
<title><?php echo (isset($tpshop_config['shop_info_store_name']) && ($tpshop_config['shop_info_store_name'] !== '')?$tpshop_config['shop_info_store_name']:config('shop_info.copyright')); ?></title>
...
<div class="admincp-header">
		 ...
		 <div class="notice-list fl">
		        <ul>
		            <?php if(is_array($notices) || $notices instanceof \think\Collection || $notices instanceof \think\Paginator): if( count($notices)==0 ) : echo "" ;else: foreach($notices as $key=>$list): ?>
		                <li ><a href="<?php echo url('Notice/detail'); ?>?id=<?php echo $list['article_id']; ?>" style="color:red;"><?php echo $list['title']; ?></a></li>
	...
	<div class="admincp-header-r">
		<div class="manager">
			<!--服务器升级-->
      		...
      		<?php endif; ?>
      		<!--服务器升级 end-->
            <a href="http://help.tp-shop.cn/Index/Help/channel/cat_id/5.html" style="display: <?php echo tpCache('basic.is_manual')?'block':'none'; ?>"  class="manual" target="_blank">帮助</a>
    	</div>
        <div class="operate bgd-opa">
            ...
            <ul class="bgdopa-list">
                ...
                <li><a class="sitemap show-option" id="trace_show" onclick="cleanCache()" target="workspace">更新缓存</a></li>
                ...
                <li><a class="changepasd" onClick="CUR_DIALOG = ajax_form('modifypw', '修改密码', '<?php echo url('Admin/modify_pwd',array('admin_id'=>$admin_info['admin_id'])); ?>');"  href="javascript:void(0);">修改密码</a></li>
                <li><a href="#" class="novice">新手向导</a></li>
                <li><a class="login-out show-option" href="<?php echo url('Admin/logout'); ?>">退出系统</a></li>
			</ul>
        </div>
  	</div>
  	<div class="clear"></div>
    <script>
        function cleanCache() {
            $.ajax({
                type:"POST",
                url:"/index.php?m=Admin&c=System&a=cleanCache",
                data:{quick:1,ajax:'ajax'},
                dataType:"json",
                success: function (data) {
                    parent.layer.msg('缓存清除成功', {time:3000,icon: 1});
...
<div class="admincp-container-left">
    ...
    <?php endforeach; endif; else: echo "" ;endif; ?>
    <div class="about" title="关于系统" onclick="javascript:layer.open({type: 2,title: '关于我们',shadeClose: true,shade: 0.3,area: ['50%', '60%'],content:'<?php echo url("Index/about"); ?>', });"><i class="fa fa-copyright"></i><span><?php echo config('shop_info.copyright'); ?></span></div>
</div>
