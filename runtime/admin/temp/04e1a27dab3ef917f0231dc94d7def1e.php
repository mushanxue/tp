<?php /*a:2:{s:48:"Z:\demo\app\admin\view\promotion/flash_sale.html";i:1593659384;s:41:"Z:\demo\app\admin\view\public/layout.html";i:1593659384;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
	...
	<div class="flexigrid">
		<div class="mDiv">
            ...
            <a href="<?php echo url('Promotion/flash_sale_info'); ?>"><div class="fbutton"><div title="添加活动" class="add"><span><i class="fa fa-plus"></i>添加活动</span></div></div></a>
		...
		<!--<div class="tDiv">
			<div class="tDiv2">
				<a href="<?php echo url('Promotion/flash_sale_info'); ?>">
					<div class="fbutton">
				...
				<table>
					...
					<?php if(is_array($prom_list) || $prom_list instanceof \think\Collection || $prom_list instanceof \think\Paginator): if( count($prom_list)==0 ) : echo "" ;else: foreach($prom_list as $k=>$vo): ?>
						<tr>
							...
							<td align="left" class="">
								<div style="text-align: left; width: 240px;"><a href="<?php echo url('Home/Goods/goodsInfo',['id'=>$vo['goods_id'],'item_id'=>$vo['item_id']]); ?>"><?php echo $vo['title']; ?></a></div>
							</td>
							<td align="left" class="">
							...
							<td align="left" class="">
								<div style="text-align: center; width: 120px;"><?php echo date('Y-m-d H:i:s',!is_numeric($vo['start_time'])? strtotime($vo['start_time']) : $vo['start_time']); ?></div>
							</td>
							<td align="left" class="">
								<div style="text-align: center; width: 120px;"><?php echo date('Y-m-d H:i:s',!is_numeric($vo['end_time'])? strtotime($vo['end_time']) : $vo['end_time']); ?></div>
							</td>
							<td align="left" class="">
							...
							<td align="left" class="handle">
								<div style="text-align: left; width: 150px; max-width:170px;">
									<a class="btn blue" href="<?php echo url('Promotion/flash_sale_info',array('id'=>$vo['id'])); ?>">编辑</a>
									<a class="btn red" href="javascript:void(0)" data-url="<?php echo url('Promotion/flash_sale_del'); ?>" data-id="<?php echo $vo['id']; ?>" onClick="delfun(this)">删除</a>
								</div>
							</td>
