<?php /*a:1:{s:62:"Z:\TPshop20200701_tp6\app/admin/view/public/dispatch_jump.html";i:1593659384;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
...
.recigle .copyright{color: #3c8dbc;}
	...
	<body class="tranjump">
		<div class="rectangle_box">
			...
			<div class="recigle">
				<p>Copyright©2014-2017<em class="copyright"><a class="copyright" href="http://<?php echo config('shop_info.domain_name'); ?>/"><?php echo (isset($tpshop_config['shop_info_store_name']) && ($tpshop_config['shop_info_store_name'] !== '')?$tpshop_config['shop_info_store_name']:config('shop_info.copyright')); ?> v3.0.0</a></em></p>
				<p><em class="copyright"><a class="copyright" href="http://<?php echo config('shop_info.domain_name'); ?>/"><?php echo (isset($tpshop_config['shop_info_store_name']) && ($tpshop_config['shop_info_store_name'] !== '')?$tpshop_config['shop_info_store_name']:config('shop_info.copyright')); ?></a></em>出品</p>
			</div>
		</div>
