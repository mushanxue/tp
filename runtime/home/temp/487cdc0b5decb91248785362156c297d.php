<?php /*a:4:{s:43:"../template/pc/rainbow/goods/goodsList.html";i:1593659405;s:41:"../template/pc/rainbow/public/header.html";i:1593659405;s:41:"../template/pc/rainbow/public/footer.html";i:1593659405;s:47:"../template/pc/rainbow/public/sidebar_cart.html";i:1593659405;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
...
<div class="search-box p">
	<div class="w1430">
		<div class="search-path fl">
			<a href="<?php echo url('Home/Goods/goodsList',array('id'=>$cat_id)); ?>">全部结果</a>
			<i class="litt-xyb"></i>
			<!--如果当前分类是三级分类 则二级也要显示-->
					...
					<div class="hovshz">
						<ul>
							<?php if(is_array($goods_category) || $goods_category instanceof \think\Collection || $goods_category instanceof \think\Paginator): if( count($goods_category)==0 ) : echo "" ;else: foreach($goods_category as $k=>$v): if(($v['parent_id'] == $goods_category[$goodsCate['parent_id']]['parent_id'])): ?>
									<li><a href="<?php echo url('Home/Goods/goodsList',array('id'=>$v['id'])); ?>"><?php echo $v['name']; ?></a></li>
								<?php endif; ?>
							<?php endforeach; endif; else: echo "" ;endif; ?>
						</ul>
					</div>
			...
			<?php if($goodsCate['level'] == 1): ?>
				<div class="havedox">
					<div class="disenk"><span><a href="<?php echo url('Home/Goods/goodsList',array('id'=>$goodsCate['id'])); ?>"><?php echo $goodsCate['name']; ?></a></span><i class="litt-xxd"></i></div>
					<div class="hovshz">
						<ul>
		...
		<div class="search-clear fr">
			<span><a href="<?php echo url('Home/Goods/goodsList',array('id'=>$cat_id)); ?>">清空筛选条件</a></span>
		</div>
	</div>
</div>
<!-- 筛选 start -->
                            ...
                            <div class="brand-list">
                                <div class="clearfix p">
                                    <?php if(is_array($goods_category) || $goods_category instanceof \think\Collection || $goods_category instanceof \think\Paginator): if( count($goods_category)==0 ) : echo "" ;else: foreach($goods_category as $k=>$v): if($v['parent_id'] == $goodsCate['id']): ?>
                                            <a href="<?php echo url('Home/Goods/goodsList',array('id'=>$v['id'])); ?>">
	...
	<div class="w1430">
		<div class="tjhot fl">
			...
			<div class="tjhot-shoplist" id="ajax_hot_goods">
                <?php
                                ...
                                {                            
                                    $result_name = $sql_result_vo = \think\facade\Db::query("select goods_id,goods_name,shop_price from `__PREFIX__goods` where is_hot=1 and is_on_sale = 1 limit 5"); 
                                    cache("sql_".$md5_key,$sql_result_vo,1);
                                }    
                              foreach($sql_result_vo as $k=>$vo): ?>
                    <div class="alone-shop">
                        <a href="<?php echo url('Home/Goods/goodsInfo',array('id'=>$vo['goods_id'])); ?>" target="_blank"><img class="lazy" data-original="<?php echo goods_thum_images($vo['goods_id'],180,180); ?>"/></a>
                        <p class="line-two-hidd"><a href="<?php echo url('Home/Goods/goodsInfo',array('id'=>$vo['goods_id'])); ?>"><?php echo $vo['goods_name']; ?></a></p>
		...
		<div class="stsho fr">
			<div class="sx_topb ba-dark-bg">
				<div class="f-sort fl">
					<ul>
						<li class="<?php if(app('request')->param('sort') == ''): ?>red<?php endif; ?>">
                            <a href="<?php echo urldecode(url("/Home/Goods/goodsList",$filter_param,''));?>">综合</a>
                        </li>
						<li class="<?php if(app('request')->param('sort') == 'sales_sum'): ?>red<?php endif; ?>">
                            <a href="<?php echo urldecode(url("/Home/Goods/goodsList",array_merge($filter_param,array('sort'=>'sales_sum')),''));?>">销量</a>
                        </li>
						<?php if(app('request')->param('sort_asc') == 'desc'): ?>
							<li class="<?php if(app('request')->param('sort') == 'shop_price'): ?>red<?php endif; ?>">
                                <a href="<?php echo urldecode(url("/Home/Goods/goodsList",array_merge($filter_param,array('sort'=>'shop_price','sort_asc'=>'asc')),''));?>">价格<i class="litt-zzx1"></i></a>
                            </li>
						<?php else: ?>
							<li class="<?php if(app('request')->param('sort') == 'shop_price'): ?>red<?php endif; ?>">
                                <a href="<?php echo urldecode(url("/Home/Goods/goodsList",array_merge($filter_param,array('sort'=>'shop_price','sort_asc'=>'desc')),''));?>">价格<i class="litt-zzx1"></i></a>
                            </li>
						<?php endif; ?>
						<li class="<?php if(app('request')->param('sort') == 'comment_count'): ?>red<?php endif; ?>">
                            <a href="<?php echo urldecode(url("/Home/Goods/goodsList",array_merge($filter_param,array('sort'=>'comment_count')),''));?>">评论</a>
                        </li>
						<li class="<?php if(app('request')->param('sort') == 'is_new'): ?>red<?php endif; ?>">
                            <a href="<?php echo urldecode(url("/Home/Goods/goodsList",array_merge($filter_param,array('sort'=>'is_new')),''));?>">新品</a>
                        </li>
					</ul>
				</div>
				...
				<div class="f-total fr">
					...
					<div class="all-fy">
						<a <?php if($nowPage > 1): ?>href="<?php echo url('Home/Goods/goodsList',array_merge($filter_param,array('p'=>$nowPage-1))); ?>" <?php endif; ?>>&lt;</a>
							<p class="fy-y"><span class="z-cur"><?php echo $nowPage; ?></span>/<span><?php echo $totalPages; ?></span></p>
						<a <?php if(($nowPage+1) <= $totalPages): ?>href="<?php echo url('Home/Goods/goodsList',array_merge($filter_param,array('p'=>$nowPage+1))); ?>" <?php endif; ?>>&gt;</a>
					</div>
				</div>
			</div>
				...
				<ul>
                    ...
                    <?php else: if(is_array($goods_list) || $goods_list instanceof \think\Collection || $goods_list instanceof \think\Paginator): if( count($goods_list)==0 ) : echo "" ;else: foreach($goods_list as $k=>$v): ?>
                            <li>
                                <div class="s_xsall">
                                    <div class="xs_img">
                                        <a href="<?php echo url('/Home/Goods/goodsInfo',array('id'=>$v['goods_id'])); ?>" target="_blank">
                                    ...
                                    <div class="shop_name2">
                                        <a href="<?php echo url('/Home/Goods/goodsInfo',array('id'=>$v['goods_id'])); ?>">
                                    ...
                                    <div class="J_btn_statu">
                                        ...
                                        <div class="p-btn">
                                            <?php if(($v['is_virtual'] == 1)): ?>
                                                <a href="<?php echo url('/Home/Goods/goodsInfo',array('id'=>$v['goods_id'])); ?>">查看详情</a>
                                                <?php else: ?>
