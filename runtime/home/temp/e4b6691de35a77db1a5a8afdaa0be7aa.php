<?php /*a:4:{s:46:"../template/pc/rainbow/goods/integralMall.html";i:1593659405;s:41:"../template/pc/rainbow/public/header.html";i:1593659405;s:41:"../template/pc/rainbow/public/footer.html";i:1593659405;s:47:"../template/pc/rainbow/public/sidebar_cart.html";i:1593659405;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
		...
		<div class="search-box p">
			<div class="w1224">
				<div class="search-path fl">
					<a href="<?php echo url('Home/Goods/integralMall'); ?>">全部结果</a>
					<i class="litt-xyb"></i>
					<span>积分商城</span>
				</div>
				<div class="search-clear fr">
					<span><a href="<?php echo url('Home/Goods/integralMall'); ?>">清空筛选条件</a></span>
				</div>
			</div>
		</div>
    <!--分类-s-->
							...
							<div class="lf-list">
								<div class="brand-list">
									<div class="clearfix p">
										<a href="<?php echo url('Home/Goods/integralMall'); ?>">
											<span <?php if(app('request')->param('id') == ''): ?>class="red"<?php endif; ?>>全部</span>
										</a>
                                        <?php if(is_array($goods_category) || $goods_category instanceof \think\Collection || $goods_category instanceof \think\Paginator): $i = 0; $__LIST__ = $goods_category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$gc): $mod = ($i % 2 );++$i;?>
                                            <a href="<?php echo url('Home/Goods/integralMall',array('id'=>$gc['id'])); ?>">
                                                <span <?php if(app('request')->param('id') == $gc['id']): ?>class="red"<?php endif; ?>><?php echo $gc['name']; ?></span>
                                            </a>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
									</div>
								</div>
			...
			<div class="w1224">
				<div class="stsho pre-sts intergra">
					<div class="sx_topb presellall">
						<div class="f-sort fl">
							<ul>
								<li <?php if(app('request')->param('brandType') == '0'): ?>class="red"<?php endif; ?>><a href="<?php echo url('Home/Goods/integralMall',array('id'=>input('get.id'),'brandType'=>0)); ?>">全部<i class="jta jta-w"></i></a></li>
								<li <?php if(app('request')->param('brandType') == '1'): ?>class="red"<?php endif; ?>><a href="<?php echo url('Home/Goods/integralMall',array('id'=>input('get.id'),'brandType'=>1)); ?>">积分+金额<i class="jta"></i></a></li>
								<li <?php if(app('request')->param('brandType') == '2'): ?>class="red"<?php endif; ?>><a href="<?php echo url('Home/Goods/integralMall',array('id'=>input('get.id'),'brandType'=>2)); ?>">全积分<i class="jta"></i></a></li>
							</ul>
						</div>
						<div class="f-total fr">
                            <div class="all-sec">共<span><?php echo $goods_list_count; ?></span>个商品</div>
							<div class="all-fy">
                                <a <?php if($nowPage > 1): ?>href="<?php echo url('Home/Goods/integralMall',array_merge(input('get.'),array('p'=>$nowPage-1))); ?>" <?php endif; ?>>&lt;</a>
                                <p class="fy-y"><span class="z-cur"><?php echo $nowPage; ?></span>/<span><?php echo $totalPages; ?></span></p>
                                <a <?php if(($nowPage+1) < $totalPages): ?>href="<?php echo url('Home/Goods/integralMall',array('p'=>$nowPage+1)); ?>"<?php endif; ?>>&gt;</a>
                            </div>
						</div>
					</div>
							...
							<?php endif; ?>
								<li <?php if($i%3 == 0): ?>class="mar0"<?php endif; ?>>
									<div class="sbox">
										...
										<div class="contifo">
											<p class="shop_name"><a href="<?php echo url('Home/Goods/goodsInfo',array('id'=>$goods['goods_id'])); ?>"><?php echo $goods['goods_name']; ?></a></p>
											...
											<div class="duchan">
												...
												<a href="<?php echo url('Home/Goods/goodsInfo',array('id'=>$goods['goods_id'])); ?>">立即换购</a>
											</div>
										</div>
									</div>
								</li>
					...
					<div class="reco-bouti">
						...
						<div class="reacommque">
							<ul>
                                ...
                                $result_name = $sql_result_goods = cache("sql_".$md5_key);
                                if(empty($sql_result_goods))
                                {                            
                                    $result_name = $sql_result_goods = \think\facade\Db::query("select * from `__PREFIX__goods` where is_on_sale = 1 and exchange_integral > 0 and is_recommend = 1 and is_virtual = 0 limit 5"); 
                                    cache("sql_".$md5_key,$sql_result_goods,1);
                                }    
                              foreach($sql_result_goods as $k=>$goods): ?>
									...
									<div class="boxque">
										...
										<div class="coan-j p">
											...
											<div>
												<a class="chang" href="<?php echo url('Home/Goods/goodsInfo',array('id'=>$goods['goods_id'])); ?>">立即换购</a>
											</div>
										</div>
									</div>
								</li>
					...
					<div class="hotchane">
						...
						<div class="hot-change">
							<ul>
                                ...
                                if(empty($sql_result_goods))
                                {                            
                                    $result_name = $sql_result_goods = \think\facade\Db::query("select * from `__PREFIX__goods` where is_on_sale = 1 and exchange_integral > 0 and is_hot = 1 and is_virtual = 0 limit 7"); 
                                    cache("sql_".$md5_key,$sql_result_goods,1);
                                }    
                              foreach($sql_result_goods as $k=>$goods): ?>
