<?php /*a:1:{s:45:"../template/pc/rainbow/goods/ajaxComment.html";i:1593659405;}*/ ?>
    ...
    <div class="deta-descri p">
        <div class="person-ph-name">
            <div class="per-img-n p">
                <?php if($v['is_anonymous'] == 1): ?>
                    <div class="img-aroun"><img src="/pc/rainbow/static/images/headPic.jpg"/></div>
                    <div class="menb-name"> 匿名用户</div>
                <?php else: ?>
                    <div class="img-aroun"><img src="<?php echo (isset($v['head_pic']) && ($v['head_pic'] !== '')?$v['head_pic']:'/pc/rainbow/static/images/headPic.jpg'); ?>"/></div>
        ...
        <div class="person-com">
            ...
            <div class="lifr4 bolist p">
                <span><?php echo date("Y-m-d H:i:s",!is_numeric($v['add_time'])? strtotime($v['add_time']) : $v['add_time']); ?></span>
            <!--购买商品规格-->
    ...
    <div class="comment-replylist">
        <?php if(is_array($replyList[$v['comment_id']]) || $replyList[$v['comment_id']] instanceof \think\Collection || $replyList[$v['comment_id']] instanceof \think\Paginator): if( count($replyList[$v['comment_id']])==0 ) : echo "" ;else: foreach($replyList[$v['comment_id']] as $k=>$v3): ?>
            <div class="comment-reply-item hide" data-vender="0" data-name="<?php echo $reply_list['user_name']; ?>" data-uid="" style="display: block;">
                <div class="reply-infor clearfix">
                    ...
                    <div class="side">
                        <span class="date"><?php echo date('Y-m-d H:i:s',!is_numeric($v3['add_time'])? strtotime($v3['add_time']) : $v3['add_time']); ?></span>
                    </div>
                </div>
                <!--回复商家内容-s-->
        ...
        <!--<?php if($v['reply_num'] > 5): ?>-->
            <!--<div class="view-all-reply show">-->
                <!--<a href="<?php echo url('Home/Goods/reply',array('comment_id'=>$v['comment_id'])); ?>" class="view-link reply">查看全部回复</a>-->
            <!--</div>-->
        <!--<?php endif; ?>-->
    </div>
<!--商家回复-e-->
...
//            url: "<?php echo url('Home/User/reply_add'); ?>",
//            success: function (res) {
//                if (res.success) {
