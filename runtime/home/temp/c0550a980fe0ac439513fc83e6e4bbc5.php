<?php /*a:1:{s:49:"../template/pc/rainbow/cart/header_cart_list.html";i:1593659405;}*/ ?>
    ...
    <div class="mn-c-m">
        <div class="mn-c-box">
            ...
            <?php if(is_array($cartList) || $cartList instanceof \think\Collection || $cartList instanceof \think\Paginator): $i = 0; $__LIST__ = $cartList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cart): $mod = ($i % 2 );++$i;?>
                <div class="c-store">
                    <div class="c-store-tt"><?php echo date("Y-m-d H:i:s",!is_numeric($cart['add_time'])? strtotime($cart['add_time']) : $cart['add_time']); ?></div>
                    ...
                    <div class="c-item clearfix">
                        ...
                        <a href="<?php echo url('Home/Goods/goodsInfo',array('id'=>$cart['goods_id'])); ?>" class="goods-pic fl">
                            <img src="<?php echo goods_thum_images($cart['goods_id'],50,50); ?>" alt="" title="<?php echo $cart['goods_name']; ?>">
                        </a>
                        <div class="goods-cont fl">
                            <a href="<?php echo url('Home/Goods/goodsInfo',array('id'=>$cart['goods_id'])); ?>" class="goods-name"><?php echo $cart['goods_name']; ?></a>
            ...
            <div class="mn-c-total">
                ...
                <a href="<?php echo url('Home/Cart/index'); ?>" class="c-btn">去购物车结算 &gt;&gt;</a>
            </div>
        </div>
        <!--现有商品时-->
<?php endif; ?>
