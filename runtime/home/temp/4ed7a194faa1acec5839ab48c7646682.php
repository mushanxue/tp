<?php /*a:1:{s:47:"../template/pc/rainbow/index/ajax_favorite.html";i:1593659405;}*/ ?>
    ...
    <li>
        <div class="pad">
            <a href="<?php echo url('Home/Goods/goodsInfo',array('id'=>$v['goods_id'])); ?>" target="_blank">
                <img class="lazy" data-original="<?php echo goods_thum_images($v['goods_id'],200,200); ?>" style="display: inline;" />
            </a>
