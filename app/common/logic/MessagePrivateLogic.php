...
class MessagePrivateLogic extends MessageBase
{
    ...
    public function addMessage(){
        ...
        $message_id = Db::name('message_private')->insertGetId($this->message);
    ...
    {
        Db::name('message_notice')->where(['message_id' => $message_id, 'send_user_id' => $send_user_id])->delete();
        Db::name('user_message')->where(['message_id' => $message_id, 'category' => 3])->delete();
    }
