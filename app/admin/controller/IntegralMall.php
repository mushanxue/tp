...
class IntegralMall extends Base
{
    ...
    {
        $inc_type =  input('get.inc_type','integral');
        ...
        return View::fetch("index",["confArr"=>$confArr]);
    }
    ...
    public function handle()
    {
        ...
        $integralValidate = validate(\app\admin\validate\Integral::class);
...
//    }
    ...
    public function clearing()
    {
        ...
        if($admin){
            ...
            $user = Users::where(['pay_points'=>['>',0]])->select();
            if($user){
                foreach ($user as $k=>$v)
                {
