...
class Freight extends Base
{
    ...
    public function info()
    {
        ...
        if ($template_id) {
            ...
            View::assign('freightTemplate', $freightTemplate);
        }
        return View::fetch();
    }
    ...
    public function save()
    {
        ...
        $data = input('post.');
        $freightTemplateValidate = validate(\app\admin\validate\FreightTemplate::class);

        if (!$freightTemplateValidate->batch(true)->check($data)) {
        ...
        if (empty($template_id)) {
            ...
            //更新模板
            $freightTemplate = FreightTemplate::where(['template_id' => $template_id])->find();
        }
