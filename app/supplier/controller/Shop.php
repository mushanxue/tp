...
class Shop extends Base
{
    ...
    public function info()
    {
        ...
        if ($shop_id) {
            ...
            View::assign('shop_image_list', $shop_image_list);
        ...
        View::assign('suppliers_list', $suppliers_list);
    ...
    public function save(){
        ...
        $shopValidate = validate(\app\common\validate\Shop::class);

        if (!$shopValidate->scene('edit')->batch(true)->check($data)) {
