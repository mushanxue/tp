...
class Invoice extends Base
{
    ...
    public function index()
    {
        ...
        /*code_14发票模块逻辑代码*/
        //待开发票
        View::assign('wait', $invoice->hasWhere("order",['order_sn'=>['>',0],'order_status'=>['in','1,2,4'],'suppliers_id'=>$this->supplier['suppliers_id']])->where(['status' => 0])->count());
        //累计开发票数
        View::assign('total', $invoice->hasWhere("order",['order_sn'=>['>',0],'order_status'=>['in','1,2,4'],'suppliers_id'=>$this->supplier['suppliers_id']])->where(['status' => 1])->count());
        return View::fetch();
        /*code_14发票模块逻辑代码*/
    }
    ...
    function changetime()
    {
        ...
        (Db::name('invoice')->where($map)->save(['atime' => time()])) ? $status = 1 : $status = -1;
    ...
    {
        /*code_14发票模块逻辑代码*/
        $invoice_ids = input('post.invoice_ids');
