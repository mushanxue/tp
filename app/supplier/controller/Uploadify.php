...
class Uploadify extends Base{
    ...
    public function upload(){
        ...
        $fileType = input('fileType','Images');  //上传文件类型，视频，图片
         switch ($fileType)  {
             case 'Flash':
                 $upload = url('Supplier/Ueditor/videoUp',array('savepath'=>$path,'pictitle'=>'banner','dir'=>'video'));
                 $type = 'mp4,3gp,flv,avi,wmv';
                 break;
             default:
                 $upload = url('Supplier/Ueditor/imageUp',array('savepath'=>$path,'pictitle'=>'banner','dir'=>'images'));
        ...
        $info = array(
            ...
            'title' => '',
            'upload' =>$upload,
        	'fileList'=>url('Supplier/Uploadify/fileList',array('path'=>$path)),
