...
class Virtual extends Base
{
    ...
    public function __construct()
    {
        ...
        if (session('?user')) {
            ...
            if (ACTION_NAME == 'password') $_SERVER['HTTP_REFERER'] = url("Home/User/index");
        }
...
//                        $goods['spec_key_name'] .= $specGoodsPriceList[$val]['key_name'];
    ...
    public function virtual_list()
    {
        ...
        View::assign('page', $result['page']->show());
        View::assign('lists', $result['order_list']);
        View::assign('active', 'order_list');
        View::assign('active_status', input('get.type'));
