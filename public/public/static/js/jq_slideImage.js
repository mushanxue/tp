        ...
        initDom:function () {
            ...
            var slideDom = $('<div class="slideimage-wrap">' +
                ...
                '<div class="slide-canbox slideCanbox">' +
                    ...
                    '<div class="slide-prompt">请拖动滑块,确保正确配合拼图</div>'+
                    '<div class="slide-prompt1">恭喜您,验证成功</div>'+
                '</div>' +
            ...
            this.$slidePrompt = this.$ele.find('.slide-prompt');    //自增
            this.$slidePrompt1 = this.$ele.find('.slide-prompt1');    //自增
        ...
        _touchend:function(){
            ...
            _this.$slideDragBtn.on('touchend',function(){
                ...
                if((_this.disTouchX >= _this.x - _this.settings.slideAreaNum) && (_this.disTouchX < _this.x + _this.settings.slideAreaNum)){
                    console.log("成功")
                    _this.$slidePrompt1.fadeToggle(500);
                    setTimeout(function(){
                        _this.$slidePrompt1.fadeToggle(500);
                    },1500),
                    _this.slideState = true;
                    ...
                    if(!ifAnimate(_this.$slideDragBtn)){
                        console.log("失败")
                        _this.$slidePrompt.fadeToggle(500);
                        // _this.$slidePrompt.addClass("prompt-show");
                        setTimeout(function(){
                            _this.$slidePrompt.fadeToggle(500);
                            // _this.$slidePrompt.removeClass("prompt-show");
                        },1500),
                        _this.$slideDragBox.addClass('slide-fail-box');
                        _this.dragTimerState = true;
                        setTimeout(function () {
