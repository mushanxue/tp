      ...
      <div class="server">
        <table width="100%">
          ...
          <tr>
            ...
            <td><input type="text" name="dbname" id="dbname" value="tpshop6.0" class="input" onBlur="TestDbPwd(0)"></td>
          ...
          <tr style="display:none;">
          	...
          	<td colspan="2"><input style="width:18px;height:18px;" type="checkbox" checked="checked" id="demo" name="demo" value="demo">是否安装测试数据</td>
          </tr>
        </table>
        <!--  
		<table width="100%">
