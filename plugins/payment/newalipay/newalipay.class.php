...
class newalipay extends Model
{
	...
	{            
		...
		$paymentPlugin = Db::name('Plugin')->where("code='newalipay' and  type = 'payment' ")->find(); // 找到支付插件的配置
		...
		$this->alipay_config['notify_url']= SITE_URL.url('Payment/notifyUrl',array('pay_code'=>'newalipay')); //异步通知地址
		$this->alipay_config['return_url']= SITE_URL.url('Payment/returnUrl',array('pay_code'=>'newalipay')); //同步跳转
